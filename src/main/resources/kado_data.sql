...
insert  into `vendor_description`(`vendor_type`,`vendor_description`,`vendor_type_name`) values ('000','Parent for Venue','Venue'),('010','Parent for Catering','Catering'),('030','Parent for Decoration','Decoration'),('020','weeding','Weeding'),('001','venue for meeting','Meeting'),('011','Catering Weeding','Catering Weeding'),('014','Catering Meeting','Catering Meeting'),('031','Decoration weeding','Weeding Decoration'),('022','Decoration for Birthday','Birthday Decoration');
